...
export default function EnterpriseLayoutTemplate({
  ...
  return (
    <div className={`min-h-screen flex flex-col font-sans antialiased selection:bg-[#07b2b2]/20 transition-colors duration-300 ${
      ...
      {/* ========================================================================= */}
      <header className="bg-[#07b2b2] text-white px-4 sm:px-6 py-2.5 flex items-center justify-between border-b border-[#069494] shrink-0 shadow-md shadow-black/10 relative z-30 sticky top-0">
        ...
        <div className="flex items-center gap-2.5 sm:gap-3">
          ...
          <div className="hidden xl:flex items-center gap-1.5 bg-[#058a8a] px-2.5 py-1 border border-[#047777] font-mono text-xs text-white rounded-md font-bold shadow-2xs">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1 bg-[#058a8a] rounded-md border border-[#047777] hover:bg-[#047777] transition-all cursor-pointer text-[10px] uppercase font-bold font-mono text-white shadow-2xs focus-visible:ring-2 focus-visible:ring-[#2dd4bf] focus-visible:outline-none"
          ...
          <div className="flex items-center gap-2 bg-[#058a8a] border border-[#047777] px-2.5 py-1 rounded-md shadow-2xs">
          ...
          <button 
            type="button" 
            onClick={onSignOut} 
            className="text-xs bg-[#058a8a] hover:bg-[#047777] text-white px-3 py-1.5 rounded-md font-bold transition-all cursor-pointer border border-[#047777] flex items-center gap-1.5 shadow-2xs focus-visible:ring-2 focus-visible:ring-[#2dd4bf] focus-visible:outline-none"
          >
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        ...
        <nav className="w-full bg-[#069494] text-white flex items-center justify-between border-b border-[#058a8a] shrink-0 px-4 py-1.5 overflow-x-auto custom-scrollbar shadow-xs relative z-10">
          ...
          <div className="flex items-center space-x-1.5 py-0.5" id="sidebar-navigation-links">
            ...
            <button
              ...
              className={`flex items-center px-3.5 py-1.5 rounded-md text-xs font-bold cursor-pointer transition-all duration-200 whitespace-nowrap focus-visible:ring-2 focus-visible:ring-[#2dd4bf] focus-visible:outline-none ${
                activeTab === 'dashboard'
                  ? 'bg-[#058a8a] text-white border border-[#047777] font-black shadow-inner ring-1 ring-[#2dd4bf]/40'
                  : 'text-teal-50 hover:bg-[#058a8a]/60 hover:text-white font-semibold'
              }`}
            >
              ...
              >
                ...
                {triageQueueLength > 0 && (
                  <span className={`text-[9px] font-bold font-mono px-1.5 py-0.5 rounded-md min-w-[16px] flex items-center justify-center ml-2 ${
                    activeTab === 'triage' ? 'bg-[#07b2b2] text-white animate-pulse' : 'bg-[#058a8a] text-teal-100 border border-[#047777]'
                  }`}>
                    {triageQueueLength}
                  </span>
                )}
            ...
            {userRole === 'doctor' && (
              <>
                ...
                >
                  ...
                  {doctorQueueLength > 0 && (
                    <span className={`text-[9px] font-bold font-mono px-1.5 py-0.5 rounded-md min-w-[16px] flex items-center justify-center ml-2 ${
                      activeTab === 'queue' ? 'bg-[#07b2b2] text-white animate-pulse' : 'bg-[#058a8a] text-teal-100 border border-[#047777]'
                    }`}>
                      {doctorQueueLength}
                    </span>
                  )}
            ...
            {userRole === 'pharmacist' && (
              ...
              >
                ...
                {pharmacyQueueLength > 0 && (
                  <span className={`text-[9px] font-bold font-mono px-1.5 py-0.5 rounded-md min-w-[16px] flex items-center justify-center ml-2 ${
                    activeTab === 'dispensary' ? 'bg-[#07b2b2] text-white animate-pulse' : 'bg-[#058a8a] text-teal-100 border border-[#047777]'
                  }`}>
                    {pharmacyQueueLength}
                  </span>
                )}
            ...
            {userRole === 'clinic-assistant' && (
              ...
              >
                ...
                {cashierQueueLength > 0 && (
                  <span className={`text-[9px] font-bold font-mono px-1.5 py-0.5 rounded-md min-w-[16px] flex items-center justify-center ml-2 ${
                    activeTab === 'billing' ? 'bg-[#07b2b2] text-white animate-pulse' : 'bg-[#058a8a] text-teal-100 border border-[#047777]'
                  }`}>
                    {cashierQueueLength}
                  </span>
                )}
          ...
          <div className="hidden lg:flex items-center space-x-3 text-[10px] text-teal-50 font-mono pl-4 border-l border-[#058a8a] ml-4">
            ...
            <button
              ...
              className="p-1 hover:bg-[#058a8a] text-white rounded-md transition-colors border border-[#047777] focus-visible:ring-2 focus-visible:ring-[#2dd4bf] focus-visible:outline-none"
