...
export default function EnterpriseLayoutTemplate({
  ...
  return (
    <div className={`min-h-screen flex flex-col font-sans antialiased selection:bg-[#07b2b2]/20 transition-colors duration-300 ${
      ...
      {/* ========================================================================= */}
      {/* GLOBAL TOP HEADER BAR (EXECUTIVE DEEP TEAL: #0F3C4C)                       */}
      {/* ========================================================================= */}
      <header className="bg-[#0f3c4c] text-white px-4 sm:px-6 py-2.5 flex items-center justify-between border-b border-[#0b2d39] shrink-0 shadow-md shadow-black/20 relative z-30 sticky top-0">
        ...
        <div className="flex items-center gap-3 relative">
          ...
          >
            ...
            <div>
              <h1 className="text-sm font-extrabold tracking-tight uppercase leading-none font-sans text-white group-hover:text-teal-200 transition-colors flex items-center gap-1.5">
                <span>{t.clinicName || 'MEDICLINIC ENTERPRISE'}</span>
                <ChevronDown className="w-3.5 h-3.5 text-teal-200 opacity-80 group-hover:opacity-100 transition-opacity" />
              </h1>
              <span className="text-[10px] text-teal-200/80 font-mono tracking-wider font-semibold block mt-0.5">
          ...
          {showClinicInfoTooltip && (
            <div className="absolute top-12 left-0 z-50 bg-[#0b2d39] border border-[#08222c] p-4 shadow-2xl text-xs space-y-2 w-72 rounded-md animate-fadeIn text-white">
              <div className="flex items-center justify-between border-b border-[#08222c] pb-2">
                <span className="font-extrabold text-white uppercase flex items-center gap-1.5">
                  <Building className="w-3.5 h-3.5 text-teal-200" /> Shah Alam Main Branch
                </span>
        ...
        <div className="flex items-center gap-2.5 sm:gap-3">
          ...
          <div className="hidden xl:flex items-center gap-1.5 bg-[#0b2d39] px-2.5 py-1 border border-[#08222c] font-mono text-xs text-white rounded-md font-bold shadow-2xs">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-2.5 py-1 rounded-md border transition-all cursor-pointer text-[10px] uppercase font-bold font-mono shadow-2xs focus-visible:ring-2 focus-visible:ring-[#2dd4bf] focus-visible:outline-none ${
              isNightShift 
                ...
                : 'bg-[#0b2d39] text-white border border-[#08222c] hover:bg-[#08222c]'
            }`}
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1 bg-[#0b2d39] rounded-md border border-[#08222c] hover:bg-[#08222c] transition-all cursor-pointer text-[10px] uppercase font-bold font-mono text-white shadow-2xs focus-visible:ring-2 focus-visible:ring-[#2dd4bf] focus-visible:outline-none"
          ...
          <div className="bg-[#0b2d39] rounded-md border border-[#08222c] p-0.5 flex">
            <button
              type="button"
              id="lang-toggle-en"
              ...
              className={`px-2 py-0.5 rounded-md text-[10px] font-bold transition-all cursor-pointer focus-visible:ring-2 focus-visible:ring-[#2dd4bf] focus-visible:outline-none ${
                activeLanguage === 'EN' ? 'bg-[#0d9488] text-white font-black shadow-xs' : 'text-teal-200 hover:text-white'
              }`}
            >
              EN
            </button>
            <button
              ...
              className={`px-2 py-0.5 rounded-md text-[10px] font-bold transition-all cursor-pointer focus-visible:ring-2 focus-visible:ring-[#2dd4bf] focus-visible:outline-none ${
                activeLanguage === 'BM' ? 'bg-[#0d9488] text-white font-black shadow-xs' : 'text-teal-200 hover:text-white'
              }`}
            >
              BM
            </button>
          ...
          <div className="flex items-center gap-2 bg-[#0b2d39] border border-[#08222c] px-2.5 py-1 rounded-md shadow-2xs">
