    ...
    <div className="animate-fadeIn space-y-6 pb-8">
      ...
      {currentView === 'registration' ? (
        ...
        <>
            ...
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {filteredEq.length === 0 ? (
                   ...
                   <div key={eq.id} className={`flex flex-col h-full p-5 rounded-none border shadow-sm transition-all hover:shadow-md ${eq.status === 'Maintenance' ? 'border-red-200 bg-red-50/50' : 'border-slate-200 bg-white'}`}>
          ...
          {activeTab === 'logs' && (
            <div className="bg-white border border-slate-200 rounded-none shadow-sm overflow-hidden animate-fadeIn">
