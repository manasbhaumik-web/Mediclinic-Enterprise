...
export const TRANSLATIONS = {
  EN: {
    ...
    bmToggle: 'BM',
    enToggle: 'EN',
    clinicName: 'MEDICLINIC ENTERPRISE',
    online: 'ONLINE',
    offline: 'OFFLINE',
...
export const ICD10_CATALOG: ICD10Code[] = [
  ...
  { code: 'E78.5', desc: 'Hyperlipidemia, unspecified (High Cholesterol / Dyslipidemia)', category: 'Endocrine / Metabolic' },
  { code: 'J02.9', desc: 'Acute pharyngitis, unspecified (Sore Throat / Tonsillitis)', category: 'Respiratory' },
  { code: 'M54.5', desc: 'Low back pain (Lumbago / Mechanical Back Ache)', category: 'Musculoskeletal' },
  { code: 'K29.7', desc: 'Gastritis, unspecified (Stomach Ulcer / Epigastric Pain)', category: 'Gastrointestinal' },
  { code: 'J20.9', desc: 'Acute bronchitis, unspecified (Chest Cough / Bronchial Inflammation)', category: 'Respiratory' },
  { code: 'L50.9', desc: 'Urticaria, unspecified (Hives / Allergic Skin Reaction)', category: 'Dermatological' },
  { code: 'F41.1', desc: 'Generalized anxiety disorder (Anxiety / Stress Reaction)', category: 'Psychiatric' },
  { code: 'F32.9', desc: 'Major depressive disorder, single episode, unspecified (Depression)', category: 'Psychiatric' },
  { code: 'H66.90', desc: 'Otitis media, unspecified (Middle Ear Infection / Otalgia)', category: 'ENT' },
  { code: 'H60.90', desc: 'Otitis externa, unspecified (Swimmer’s Ear / Outer Ear Canal Infection)', category: 'ENT' },
  { code: 'N18.9', desc: 'Chronic kidney disease, unspecified (CKD / Renal Impairment)', category: 'Nephrology' },
  { code: 'I25.10', desc: 'Atherosclerotic heart disease of native coronary artery (Ischemic Heart Disease / CAD)', category: 'Cardiovascular' },
  { code: 'I48.91', desc: 'Unspecified atrial fibrillation (Arrhythmia / Palpitations)', category: 'Cardiovascular' },
  { code: 'E03.9', desc: 'Hypothyroidism, unspecified (Low Thyroid Hormone)', category: 'Endocrine / Metabolic' },
  { code: 'E05.90', desc: 'Thyrotoxicosis, unspecified without thyrotoxic crisis (Hyperthyroidism)', category: 'Endocrine / Metabolic' },
  { code: 'K58.9', desc: 'Irritable bowel syndrome without diarrhea (IBS / Abdominal Bloating)', category: 'Gastrointestinal' },
  { code: 'M17.9', desc: 'Osteoarthritis of knee, unspecified (Knee Joint Degeneration / Arthralgia)', category: 'Musculoskeletal' },
  { code: 'M10.9', desc: 'Gout, unspecified (Gouty Arthritis / Uric Acid Flare)', category: 'Musculoskeletal' },
  { code: 'N20.1', desc: 'Calculus of ureter (Kidney Stones / Renal Colic)', category: 'Urological' },
  { code: 'L70.0', desc: 'Acne vulgaris (Facial Acne / Papules)', category: 'Dermatological' },
  { code: 'B35.3', desc: 'Tinea pedis (Athlete’s Foot / Fungal Foot Infection)', category: 'Dermatological / Infectious' },
  { code: 'B37.0', desc: 'Candidal stomatitis (Oral Thrush / Fungal Stomatitis)', category: 'Infectious' },
  { code: 'B02.9', desc: 'Zoster without complications (Shingles / Herpes Zoster)', category: 'Infectious' },
  { code: 'G44.209', desc: 'Tension-type headache, unspecified (Tension Headache / Stress Headache)', category: 'Neurological' },
  { code: 'H57.9', desc: 'Unspecified disorder of eye and adnexa (Eye Strain / Dry Eye Syndrome)', category: 'Ophthalmological' },
  { code: 'R42', desc: 'Dizziness and giddiness (Vertigo / Motion Sickness)', category: 'Neurological' },
  { code: 'R11.2', desc: 'Nausea with vomiting, unspecified (Emesis / Motion Sickness)', category: 'Gastrointestinal' },
  { code: 'R05.9', desc: 'Cough, unspecified (Persistent Cough / Throat Irritation)', category: 'Respiratory' },
  { code: 'Z00.00', desc: 'Encounter for general adult medical examination without abnormal findings (Pre-employment / Annual Checkup)', category: 'Administrative' },
  { code: 'Z23', desc: 'Encounter for immunization (Vaccination / Flu Shot)', category: 'Administrative' },
  { code: 'S93.409', desc: 'Sprain of unspecified ligament of ankle (Ankle Sprain)', category: 'Trauma / Orthopedics' },
  { code: 'S61.409', desc: 'Unspecified open wound of hand (Laceration / Cut Wound)', category: 'Trauma' },
  { code: 'T78.40', desc: 'Allergy, unspecified (Food Allergy / Environmental Allergy)', category: 'Immunological' }
];
